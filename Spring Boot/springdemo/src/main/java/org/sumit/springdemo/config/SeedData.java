...
public class SeedData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        account01.setEmail("prasadsumit@gmail.com");
        account01.setPassword("@sumit123");
        account01.setFirstName("Sumit");
        account01.setLastName("Prasad");
        account01.setRole(Roles.USER.getRole());  // Set role to USER
        account01.setAge(20);
        LocalDate myDate = LocalDate.of(2004, 6, 24);
        account01.setDateOfBirth(myDate);  // Set date of birth
        account01.setGender("Male");
        accountServices.save(account01);  // Save to the database
          // Now accountServices is not null
        ...
        account02.setAge(18);  // Set age
        LocalDate myDate1 = LocalDate.of(2005, 7, 24);
        account02.setDateOfBirth(myDate1); // Set date of birth
        ...
        account03.setAge(21);
        LocalDate myDate2 = LocalDate.of(2008, 6, 14);
        account03.setDateOfBirth(myDate2); // Set date of birth
